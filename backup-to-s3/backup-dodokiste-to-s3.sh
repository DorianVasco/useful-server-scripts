...
export AWS_SECRET_ACCESS_KEY="YOUR_ID"
...
DEST="s3://s3.eu-central-1.amazonaws.com/YOUR_BUCKET"
...
if [ $is_running -eq 0 ]; then
    ...
    duplicity ${FULL} --include-globbing-filelist ./backup-include-dirs --exclude '**' ${DUPOPTIONS} ${SOURCE} ${DEST} >> ${DAILYLOGFILE} #2>&1
